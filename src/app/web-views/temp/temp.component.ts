...
export class TempComponent {
  ...
  @ViewChild('tempAttachementInput') tempAttachementInput!: ElementRef<HTMLInputElement>;
  attachement: File | null = null;
  type : AttachementType = AttachementType.validation
  constructor(
  ...
  async onSelectFile(event: any) {
    ...
    await this.upload();
    this.tempAttachementInput.nativeElement.value = '';
  }
 async upload(){
